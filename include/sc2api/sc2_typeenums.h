...
enum class UNIT_TYPEID {
    ...
    TERRAN_PLANETARYFORTRESS                                     = 130,   // SMART, TRAIN_SCV, LOADALL, UNLOADALL, STOP, CANCEL_LAST, ATTACK, RALLY_WORKERS
    ...
    ZERG_INFESTOR                                                = 111,   // SMART, MOVE, PATROL, HOLDPOSITION, EFFECT_FUNGALGROWTH, EFFECT_INFESTEDTERRANS, EFFECT_NEURALPARASITE, BURROWDOWN, STOP, ATTACK
